...
apk_istream* apk_istream_gunzip_mpart(apk_istream*, apk_multipart_cb cb, void* ctx);
...
apk_istream* apk_istream_segment(apk_segment_istream* sis, apk_istream* is_,
        size_t len, time_t mtime);
apk_istream* apk_istream_tee(apk_istream* from, int atfd, const(char)* to,
        int copy_meta, apk_progress_cb cb, void* cb_ctx);
